#!/usr/bin/env python3
"""R493 (FULL-CORE): v10 master — v9 + backext bodies (long+short) merged.
...
Outputs: kw_stereo_v10.wav, kw_montage_v10.wav
"""
...
if __name__ == '__main__':
    ...
    wv = wave.open('kw_stereo_v10.wav', 'wb')
    ...
    if segs:
        ...
        wv = wave.open('kw_montage_v10.wav', 'wb')
        wv.setnchannels(2); wv.setsampwidth(2); wv.setframerate(48000)
